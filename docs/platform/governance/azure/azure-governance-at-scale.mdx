---
id: azure-governance-at-scale
title: Azure Governance at Scale
slug: /platform/governance/azure
description: Principle guidance on structuring Azure governance for multi-team, cost-aware, and regulated environments.
sidebar_label: Azure Governance at Scale
keywords: [azure governance, azure governance at scale, azure management groups and subscriptions, cloud governance model, azure platform governance]
sidebar_position: 10
---
...
<ThemeDiagram
  Light={Light}
  Dark={Dark}
  label="Azure Governance high-level overview"
  height={760}
/>